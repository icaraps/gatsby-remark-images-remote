> This is a fork of [gatsby-remark-images](https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-remark-images) and simply adds remote images support. All credit goes to the original author.  
